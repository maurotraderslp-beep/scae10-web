"""Verificar estrutura da tabela CORREDORES"""
import os
import django
...
cursor.execute("""
    ...
    WHERE RDB$RELATION_NAME = 'CORREDORES' 
...
print("=" * 80)
print("ESTRUTURA DA TABELA CORREDORES")
print("=" * 80)
print("\nCampos:")
for f in fields:
    print(f"  - {f[0].strip()}")
...
cursor.execute("SELECT COUNT(*) FROM CORREDORES")
